...
struct FrogPilotPlan {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(80ae746ee2596b11, 15, 2)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
public:
  ...
  inline  ::int64_t getSafeObstacleDistance() const;

  inline  ::int64_t getSafeObstacleDistanceStock() const;
  ...
  inline  ::int64_t getStoppedEquivalenceFactor() const;
...
public:
  ...
  inline  ::int64_t getSafeObstacleDistance();
  inline void setSafeObstacleDistance( ::int64_t value);

  inline  ::int64_t getSafeObstacleDistanceStock();
  inline void setSafeObstacleDistanceStock( ::int64_t value);
  ...
  inline  ::int64_t getStoppedEquivalenceFactor();
  inline void setStoppedEquivalenceFactor( ::int64_t value);
...
inline  ::int64_t FrogPilotPlan::Reader::getSafeObstacleDistance() const {
  return _reader.getDataField< ::int64_t>(
      ::capnp::bounded<6>() * ::capnp::ELEMENTS);
}

inline  ::int64_t FrogPilotPlan::Builder::getSafeObstacleDistance() {
  return _builder.getDataField< ::int64_t>(
      ::capnp::bounded<6>() * ::capnp::ELEMENTS);
}
inline void FrogPilotPlan::Builder::setSafeObstacleDistance( ::int64_t value) {
  _builder.setDataField< ::int64_t>(
      ::capnp::bounded<6>() * ::capnp::ELEMENTS, value);
}

inline  ::int64_t FrogPilotPlan::Reader::getSafeObstacleDistanceStock() const {
  return _reader.getDataField< ::int64_t>(
      ::capnp::bounded<7>() * ::capnp::ELEMENTS);
}

inline  ::int64_t FrogPilotPlan::Builder::getSafeObstacleDistanceStock() {
  return _builder.getDataField< ::int64_t>(
      ::capnp::bounded<7>() * ::capnp::ELEMENTS);
}
inline void FrogPilotPlan::Builder::setSafeObstacleDistanceStock( ::int64_t value) {
  _builder.setDataField< ::int64_t>(
      ::capnp::bounded<7>() * ::capnp::ELEMENTS, value);
}
...
inline  ::int64_t FrogPilotPlan::Reader::getStoppedEquivalenceFactor() const {
  return _reader.getDataField< ::int64_t>(
      ::capnp::bounded<11>() * ::capnp::ELEMENTS);
}

inline  ::int64_t FrogPilotPlan::Builder::getStoppedEquivalenceFactor() {
  return _builder.getDataField< ::int64_t>(
      ::capnp::bounded<11>() * ::capnp::ELEMENTS);
}
inline void FrogPilotPlan::Builder::setStoppedEquivalenceFactor( ::int64_t value) {
  _builder.setDataField< ::int64_t>(
      ::capnp::bounded<11>() * ::capnp::ELEMENTS, value);
}
