...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"AutoOvertake", PERSISTENT | FROGPILOT_STORAGE | FROGPILOT_CONTROLS},
    {"AMapKey1", PERSISTENT},
    {"AMapKey2", PERSISTENT},
    ...
    {"LeftBlinker", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
    {"RightBlinker", CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION},
};
