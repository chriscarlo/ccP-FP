    ...
    QObject::connect(btn, &QPushButton::clicked, [=, w = panel_frame]() {
      if (w->widget() == frogpilotSettingsWindow) {
        ...
        if (!tuningLevelConfirmed) {
          // Force experience level to maximum
          // *** Lines added to ensure we "use" frogpilotHours/openpilotHours ***
          int frogpilotHours = 1000;  // > 100 hours
          int openpilotHours = 10000; // > 100 hours
          params.putInt("FrogPilotHours", frogpilotHours);
          params.putInt("OpenPilotHours", openpilotHours);
          // *** End of lines added ***

          if (FrogPilotConfirmationDialog::toggleAlert(
                tr("Since you're very experienced with FrogPilot, the 'Advanced' toggle preset has been applied, but you can change this at any time via the 'Tuning Level' button!"),
                tr("Sounds good!"), this, true)) {
