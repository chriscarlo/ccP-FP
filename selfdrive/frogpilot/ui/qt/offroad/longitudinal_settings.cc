...
FrogPilotLongitudinalPanel::FrogPilotLongitudinalPanel(FrogPilotSettingsWindow *parent) : FrogPilotListWidget(parent), parent(parent) {
  const std::vector<std::tuple<QString, QString, QString, QString>> longitudinalToggles {
    ...
    {"TrafficJerkAcceleration", tr("Acceleration Cost"), tr("Controls how much it costs us to stomp on the gas. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"TrafficJerkDeceleration", tr("Deceleration Cost"), tr("Controls how much it costs us to stomp on the brakes. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"TrafficJerkDanger", tr("Safety Constraint Cost"), tr("Controls how much it costs to get close to speed, acceleration, and following distance limits. Lower cost = willing to get closer to limits, higher cost = stays further from limits."), ""},
    {"TrafficJerkSpeed", tr("Speed Increase Cost"), tr("Controls how much it costs us to raise target speed (e.g. 20-40mph). Lower cost = faster change, higher cost = slower change."), ""},
    {"TrafficJerkSpeedDecrease", tr("Speed Decrease Cost"), tr("Controls how much it costs us to lower target speed (e.g. 40-20mph). Lower cost = faster change, higher cost = slower change."), ""},
    ...
    {"AggressiveJerkAcceleration", tr("Acceleration Cost"), tr("Controls how much it costs us to stomp on the gas. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"AggressiveJerkDeceleration", tr("Deceleration Cost"), tr("Controls how much it costs us to stomp on the brakes. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"AggressiveJerkDanger", tr("Safety Constraint Cost"), tr("Controls how much it costs to get close to speed, acceleration, and following distance limits. Lower cost = willing to get closer to limits, higher cost = stays further from limits."), ""},
    {"AggressiveJerkSpeed", tr("Speed Increase Cost"), tr("Controls how much it costs us to raise target speed (e.g. 20-40mph). Lower cost = faster change, higher cost = slower change."), ""},
    {"AggressiveJerkSpeedDecrease", tr("Speed Decrease Cost"), tr("Controls how much it costs us to lower target speed (e.g. 40-20mph). Lower cost = faster change, higher cost = slower change."), ""},
    ...
    {"StandardJerkAcceleration", tr("Acceleration Cost"), tr("Controls how much it costs us to stomp on the gas. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"StandardJerkDeceleration", tr("Deceleration Cost"), tr("Controls how much it costs us to stomp on the brakes. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"StandardJerkDanger", tr("Safety Constraint Cost"), tr("Controls how much it costs to get close to speed, acceleration, and following distance limits. Lower cost = willing to get closer to limits, higher cost = stays further from limits."), ""},
    {"StandardJerkSpeed", tr("Speed Increase Cost"), tr("Controls how much it costs us to raise target speed (e.g. 20-40mph). Lower cost = faster change, higher cost = slower change."), ""},
    {"StandardJerkSpeedDecrease", tr("Speed Decrease Cost"), tr("Controls how much it costs us to lower target speed (e.g. 40-20mph). Lower cost = faster change, higher cost = slower change."), ""},
    ...
    {"RelaxedJerkAcceleration", tr("Acceleration Cost"), tr("Controls how much it costs us to stomp on the gas. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"RelaxedJerkDeceleration", tr("Deceleration Cost"), tr("Controls how much it costs us to stomp on the brakes. Lower cost = harder stomping, higher cost = gentler stomping."), ""},
    {"RelaxedJerkDanger", tr("Safety Constraint Cost"), tr("Controls how much it costs to get close to speed, acceleration, and following distance limits. Lower cost = willing to get closer to limits, higher cost = stays further from limits."), ""},
    {"RelaxedJerkSpeed", tr("Speed Increase Cost"), tr("Controls how much it costs us to raise target speed (e.g. 20-40mph). Lower cost = faster change, higher cost = slower change."), ""},
    {"RelaxedJerkSpeedDecrease", tr("Speed Decrease Cost"), tr("Controls how much it costs us to lower target speed (e.g. 40-20mph). Lower cost = faster change, higher cost = slower change."), ""},
